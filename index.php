...
Plugin URI: https://www.feedbackstr.com/en/blog/easyshare-feedbackstr-takes-wordpress-by-storm/
Description: Integrate your <a href="https://feedbackstr.com">Feedbackstr.com</a> feedback tab or your entire survey into your Wordpress page. You can also change all tab settings directly on the Wordpress administration area. 
Version: 1.1.3
Author: spectos
Author URI: https://spectos.com
									...
									if (typeof(SideTab) !== \"undefined\") {
										SideTab.init(
											{ 
												...
												tabPosition: \""; echo 'Left'; echo "\", 
												tabFontColor: \""; echo get_option('fdbac_txtcolor'); echo "\",
